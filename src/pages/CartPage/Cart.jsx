                        ...
                        <div>
                            {cartItem.map((book, index) => (
                                <div key={index} className='px-3 mt-2 mx-auto py-5 grid grid-cols-7 border-t w-[95%] relative'>
                                    ...
                                    <p className='col-span-1 m-auto s:hidden lg:block'>{(book.original_price - (book.original_price * book.discount) / 100).toLocaleString()}&#8363;</p>
                                    ...
                                    <p className='lg:col-span-1 s:mt-5 md:m-auto s:col-span-2'>{(book.quantity * (book.original_price - (book.original_price * book.discount) / 100)).toLocaleString()}&#8363;</p>
