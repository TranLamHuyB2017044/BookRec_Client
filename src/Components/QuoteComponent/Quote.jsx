...
export default function Quote() {
  return (
    <div className=' h-[350px] md:h-[300px]  mt-5 bg-[#18335e] text-white'>
      <Fade arrows={false} duration={3000}>
        <div className='each-slide lg:w-full mx-auto lg:mt-60 md:mt-44 flex flex-col gap-16 h-[350px] s:max-w-[60%] md:max-w-[80%]'>
        ...
        <div className='each-slide lg:w-full mx-auto lg:mt-60 md:mt-28 flex flex-col gap-16 h-[350px]  s:max-w-[60%]md:max-w-[80%]'>
        ...
        <div className='each-slide lg:w-full mx-auto lg:mt-60 md:mt-48 flex flex-col gap-16 h-[350px] s:max-w-[60%] md:max-w-[80%]'>
