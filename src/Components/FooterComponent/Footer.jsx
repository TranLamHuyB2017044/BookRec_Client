            ...
            <div className='flex items-center min-h-[200px]  bg-[#f47830] h-[300px]'>
                ...
                <div className='flex-1 text-white flex flex-col gap-5 py-5 min-h-[200px]'>
                    ...
                    <ul className='flex flex-col justify-between gap-5'>
                        ...
                        <li >Chính sách đổi trả hoàn tiền</li>
                    </ul>
                </div>
                <div className='flex-1 text-white flex flex-col gap-5 py-5 min-h-[200px]'>
                    <h2 className='text-4xl font-bold'>Liên Hệ</h2>
                    <p className='flex items-center gap-5 max-w-[60%]'><LocationOnOutlinedIcon fontSize='large'/> Khu II, Đ. 3 Tháng 2, Xuân Khánh, Ninh Kiều, Cần Thơ, Việt Nam</p>
                    <p className='flex items-center gap-5 '><MailOutlineOutlinedIcon fontSize='large'/> tranlamhuy5tn@gmail.com</p>
                    <p className='flex items-center gap-5'> <PhoneOutlinedIcon fontSize='large'/> 0939419860 </p>
                </div>
            </div>
